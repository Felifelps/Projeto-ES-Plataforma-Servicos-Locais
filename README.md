...
A Plataforma de Serviços Locais resolve esse prob# Projeto-ES — Plataforma de Serviços Locais
...
lema centralizando a busca, o cadastro e a avaliação de prestadores de serviço em um único ambiente, facilitando a conexão entre moradores de uma região e profissionais qualificados próximos a eles.
...
- JDK 17 ou superior instalado
- Git instalado
- Banco de dados configurado (a definir)
